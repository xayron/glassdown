...
// in glass_down_v2/test/helpers/test_helpers.dart.
...
class _FakeAppInfo_0 extends _i1.SmartFake implements _i2.AppInfo {
  _FakeAppInfo_0(
    Object parent,
...
///
/// See the documentation for Mockito's code generation for more information.
class MockScraperService extends _i1.Mock implements _i9.ScraperService {
  @override
  (bool?, String?) get pageStatus => (super.noSuchMethod(
  ...
  @override
  (bool?, String?) get linkStatus => (super.noSuchMethod(
        Invocation.getter(#linkStatus),
        returnValue: (null, null),
        returnValueForMissingStub: (null, null),
      ) as (bool?, String?));

  @override
  (bool?, String?) get apkStatus => (super.noSuchMethod(
        Invocation.getter(#apkStatus),
        returnValue: (null, null),
        returnValueForMissingStub: (null, null),
      ) as (bool?, String?));

  @override
  (bool?, String?) get saveStatus => (super.noSuchMethod(
        Invocation.getter(#saveStatus),
        returnValue: (null, null),
        returnValueForMissingStub: (null, null),
      ) as (bool?, String?));
  ...
  @override
  void clearStatuses() => super.noSuchMethod(
        Invocation.method(
          #clearStatuses,
          [],
        ),
  ...
  @override
  _i7.Future<String?> getAppImage(({String name, String url})? app) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAppImage,
          [app],
  ...
  @override
  _i7.Future<_i2.AppInfo> getVersionList(
    _i2.AppInfo? app,
    _i10.CancelToken? token, {
    int? page = 1,
    bool? innerFn = false,
  }) =>
      (super.noSuchMethod(
        ...
        returnValue: _i7.Future<_i2.AppInfo>.value(_FakeAppInfo_0(
          this,
          Invocation.method(
            #getVersionList,
            [
        ...
        returnValueForMissingStub: _i7.Future<_i2.AppInfo>.value(_FakeAppInfo_0(
          this,
          Invocation.method(
            #getVersionList,
            [
      ...
      ) as _i7.Future<_i2.AppInfo>);

  @override
  _i7.Future<_i2.AppInfo> getApkType(
    _i2.AppInfo? app,
    _i10.CancelToken? token,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<bool> getSelectedApk(
    _i2.AppInfo? app,
    _i10.CancelToken? token,
  ) =>
      (super.noSuchMethod(
...
/// A class which mocks [PathsService].
///
/// See the documentation for Mockito's code generation for more information.
class MockPathsService extends _i1.Mock implements _i11.PathsService {
  @override
  _i7.Future<_i3.Directory> getFolderToSave() => (super.noSuchMethod(
        Invocation.method(
          #getFolderToSave,
          [],
        ),
        returnValue: _i7.Future<_i3.Directory>.value(_FakeDirectory_1(
          this,
          Invocation.method(
            #getFolderToSave,
            [],
        ...
        returnValueForMissingStub:
            _i7.Future<_i3.Directory>.value(_FakeDirectory_1(
          this,
          Invocation.method(
            #getFolderToSave,
            [],
...
class MockAppsService extends _i1.Mock implements _i12.AppsService {
  @override
  List<_i2.AppInfo> get apps => (super.noSuchMethod(
        Invocation.getter(#apps),
        returnValue: <_i2.AppInfo>[],
        returnValueForMissingStub: <_i2.AppInfo>[],
      ) as List<_i2.AppInfo>);
  ...
  @override
  void comparator() => super.noSuchMethod(
        Invocation.method(
          #comparator,
          [],
        ),
  ...
  @override
  _i7.Future<void> loadAppsFromDb() => (super.noSuchMethod(
        Invocation.method(
          #loadAppsFromDb,
          [],
        ),
  ...
  @override
  _i7.Future<void> addApp(({String name, String url})? appInfo) =>
      (super.noSuchMethod(
        Invocation.method(
          #addApp,
          [appInfo],
  ...
  @override
  _i7.Future<bool> editApp(
    ({String name, String url})? protoApp,
    _i2.AppInfo? app,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i7.Future<void> removeApp(_i2.AppInfo? app) => (super.noSuchMethod(
        Invocation.method(
          #removeApp,
          [app],
        ),
  ...
  @override
  _i7.Future<_i13.IOError?> importAppList() => (super.noSuchMethod(
        Invocation.method(
          #importAppList,
          [],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockLogsService extends _i1.Mock implements _i14.LogsService {
  @override
  _i7.Future<_i13.IOError?> exportLogs() => (super.noSuchMethod(
        Invocation.method(
          #exportLogs,
          [],
        ),
  ...
  @override
  _i7.Future<_i13.IOError?> deleteLogs() => (super.noSuchMethod(
        Invocation.method(
          #deleteLogs,
          [],
        ),
